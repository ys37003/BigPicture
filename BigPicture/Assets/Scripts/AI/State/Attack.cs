...
public class Attack : State
{
    ...
    public void Enter(object _entity)
    {
        ...
        if (null != entity.AttackHandler)
        {
            ...
            MessageDispatcher.Instance.DispatchMessage(0, entity.ID, entity.EnemyList[0].enemy.GetComponent<BaseGameEntity>().ID, (int)eMESSAGE_TYPE.AVOID_ATTACK, entity.GetEnemyPosition() );
        }
