...
public class DragonBreath : State {

    private static DragonBreath instance;
    Dragon entity;
    ...
    public static DragonBreath Instance()
    {
        if (instance == null)
        {
            instance = new DragonBreath();
        }
        return instance;
    }
    ...
    public void Excute(object _entity)
    {
        ...
        if( true == entity.EndDragonBreath())
        {
